...
RSpec.describe Books::Book, search: true do
  describe 'searching' do
    it 'searches books by title' do
      ...
      results = Books::Book.search('design patterns')
    ...
    it 'searches books by description' do
      ...
      results = Books::Book.search('computers')
    ...
    it 'searches books by author' do
      ...
      results = Books::Book.search('evans')
    ...
    it 'searches books by tag' do
      ...
      results = Books::Book.search('ruby')
  ...
  describe 'filtering' do
    it 'filters by tag' do
      ...
      results = Books::Book.search(where: { tags: ['Ruby'] })
    ...
    it 'filters by author' do
      ...
      results = Books::Book.search(where: { authors: ['Eric Evans'] })
